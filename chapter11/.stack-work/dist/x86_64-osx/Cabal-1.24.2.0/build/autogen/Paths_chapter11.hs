...
sysconfdir = "/Users/amadhavan1/dev/haskell-projects/haskell-first-principles/chapter11/.stack-work/install/x86_64-osx/lts-9.6/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "chapter11_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "chapter11_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "chapter11_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "chapter11_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "chapter11_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "chapter11_sysconfdir") (\_ -> return sysconfdir)
